...
- `test_ux.sh` — UX testing script using tmux to verify TUI functionality: marquee scrolling, recurring marks, DONE pane stats, timer display, header timer, view persistence, view selector spacing. Automatically builds, installs, tests, and cleans up tmux sessions.
